...
module Day7
  ...
  def self.type_hand_with_jokers(hand)
  ...
  def self.type_hands(hands_with_scores, with_wilds: false)
  ...
  def self.sort_hands(typed_with_scores, ranks: NORMAL_RANKS)
  ...
  def self.sum_ranks(sorted_typed_with_scores)
